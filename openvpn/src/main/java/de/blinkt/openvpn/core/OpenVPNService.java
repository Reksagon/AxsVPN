...
//    private static final String RESUME_VPN = "de.blinkt.openvpn.RESUME_VPN";
    ...
    public static String mState = "NOPROCESS";
        ...
        if (runningOnAndroidTV() && !(priority < 0))
            guiHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (mlastToast != null)
                        mlastToast.cancel();
                    String toastText = String.format(Locale.getDefault(), "AxsVPN - %s", msg);
...
//            }
    ...
    public ParcelFileDescriptor openTun() {
        ...
        if (mLocalIP == null) {
            VpnStatus.logInfo(R.string.local_ip_info, null, -1, mLocalIPv6, mMtu);
        } else {
